...
-- DROP TABLE IF EXISTS public.watchlistitem;
...
-- DROP TABLE IF EXISTS public.tv_episodes;
...
ALTER TABLE IF EXISTS public.scrape_results
    OWNER to postgres;
-- Index: idx_scrape_results_status

-- DROP INDEX IF EXISTS public.idx_scrape_results_status;
...
CREATE INDEX IF NOT EXISTS idx_scrape_results_status
    ...
    TABLESPACE pg_default;
-- Index: idx_scrape_results_watchlist_item_id

-- DROP INDEX IF EXISTS public.idx_scrape_results_watchlist_item_id;
